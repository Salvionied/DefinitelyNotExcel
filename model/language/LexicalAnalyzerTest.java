...
public class LexicalAnalyzerTest {
    ...
    public void testHumanReadableName() {
        final LexicalAnalyzer l = new LexicalAnalyzer("12.2");
        l.fetchNextToken();
        final Token t = l.getCurrentToken();
        final String s = t.getType().getName();
        assertEquals("double",s);
    }
    
    @Test
    public void testDiscernDifferentTokenTypes() {
        final LexicalAnalyzer l = new LexicalAnalyzer("A0:B0+C0");
        l.fetchNextToken();
        Token t = l.getCurrentToken();
        assertEquals(t.getType(),TokenType.RANGE);
        l.fetchNextToken();
        t = l.getCurrentToken();
        assertEquals(t.getType(),TokenType.PLUS);
        l.fetchNextToken();
        t = l.getCurrentToken();
        assertEquals(t.getType(), TokenType.CELLIDENTIFIER);
    }
