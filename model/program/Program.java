...
public class Program {
    ...
    public Number execute() {
        final SheetModel variables = new SheetModel();
     ...
     * The result is the top element of the operand stack,
     * after executing all instructions.
     * @param variables The SheetModel with all the cells
     *        (accessed by Nload or RangeLoad instructions)
     *        
     * @return The result of the execution.
     */
    public Number execute(final SheetModel variables)  {
